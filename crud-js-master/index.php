                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="login2"><small>Raça</small></label>
                                    <input type="text" class="form-control" name="raca" id="login2" placeholder="Digite seu login" >
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="senha2"><small>Sexo</small></label>
                                    <input type="text" class="form-control" name="sexo" id="senha2" placeholder="Digite sua senha">
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="senha2"><small>Cor</small></label>
                                    <input type="text" class="form-control" name="cor" id="senha2" placeholder="Digite sua senha">
                                </div><div class="col-md-12 form-group">


                                    <label for="senha2"><small>Nascimento</small></label>
                                    <input type="text" class="form-control" name="nascimento" id="senha2" placeholder="Digite sua senha">
                                </div><div class="col-md-12 form-group">

                                    <label for="senha2"><small>Peso</small></label>
                                    <input type="text" class="form-control" name="peso" id="senha2" placeholder="Digite sua senha">
                                </div><div class="col-md-12 form-group">

                                    <label for="senha2"><small>Altura</small></label>
                                    <input type="text" class="form-control" name="altura" id="senha2" placeholder="Digite sua senha">
                                </div>
